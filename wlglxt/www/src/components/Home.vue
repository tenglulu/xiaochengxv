        ...
        <div>
          <el-dropdown @command="handleCommand">
            ...
            <el-dropdown-menu slot="dropdown">
              ...
              <el-dropdown-item divided disabled>您的身份为：{{$store.state.user.identity}}</el-dropdown-item>
            </el-dropdown-menu>
          </el-dropdown>
        </div>
      </el-header>
      ...
      <el-container style="height: 743px">
        ...
        <el-main>
          ...
          <div  v-if="this.$router.currentRoute.path=='/home'">
            <div>
              <template>
                <el-carousel :interval="3000" arrow="always" class="d_jump" >
                <el-carousel-item v-for="item in imgList" :key="item.id">
                  <el-row> <el-col :span="24">
                    <img :src="user.avatar" class="banner_img"/></el-col>
                    {{$store.state.user}}
                  </el-row>
                </el-carousel-item>
              </el-carousel>
            ...
            <div  style="height: 200px">
              <ul id="gov">
                ...
                <li class="li1">
                  <a class="gov4" href="#" target="_blank" oncontextmenu="return false;">
                    <img src="#" title="哈尔滨市市场监督管理局企业主体身份公示" alt="哈尔滨市市场监督管理局企业主体身份公示">
                  </a>
                </li>
              </ul>
            </div>
            <div style="height: 35px;width: 100%">
              ...
              <ul id="copyright">
                ...
                <li class="li1"> <a href="#" target="_blank">粤&nbsp;&nbsp;ICP&nbsp;&nbsp;备08034243号</a></li>
              </ul>
            </div>
          </div>
          <router-view/>
...
export default {
  ...
  data() {
    return {
      imgList: [
        { id: 0, idView: require("../assets/a1.jpeg") },
